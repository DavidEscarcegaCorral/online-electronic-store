...
- `negocio_configuracion` — Subsistema que gestiona el flujo de configuración paso a paso y expone una ventacontrol (`ConfiguracionFacade`).
- `negocio_venta` — Subsistema de ventas y venta, con su ventacontrol (`VentaFacade` o similar).
